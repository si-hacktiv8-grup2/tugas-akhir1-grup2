      ...
      <div class="site-section">
        <div class="container">
          ...
          <div class="cta d-block d-md-flex align-items-center px-5">
            <div>
              <h2 class="mb-0">Ready for a next trip?</h2>
          ...
          <div class="row">
            ...
            <div class="col-sm">
              <a href="#" class="footer-logo"><img src="assets/images/globe.png" width="30" height="30" class="d-inline-block align-top"> Chill.Tour</a>
              <p class="copyright">
